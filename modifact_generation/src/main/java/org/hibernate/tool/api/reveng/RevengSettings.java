...
public class RevengSettings {
  ...
  /**
   * If true, reverse engineering strategy will try and autodetect columns for optimistc locking,
   * e.g. VERSION and TIMESTAMP
   */
  ...
  /**
   * return the top/root strategy. Allows a lower strategy to ask another question. Be aware of
   * possible recursive loops; e.g. do not call the root.tableToClassName in tableToClassName of a
   * custom reversengineeringstrategy.
   */
