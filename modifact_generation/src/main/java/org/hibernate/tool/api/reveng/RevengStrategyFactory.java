...
public class RevengStrategyFactory {
  ...
  public static RevengStrategy createReverseEngineeringStrategy(
    ...
    try {
      ...
      throw new RuntimeException(
          "An exporter of class '" + reverseEngineeringClassName + "' could not be created",
          exception);
    }
    return result;
  }
  ...
  public static RevengStrategy createReverseEngineeringStrategy(
      String reverseEngineeringClassName, File[] revengFiles) {
    RevengStrategy result = createReverseEngineeringStrategy(reverseEngineeringClassName);
