...
public class HQLCompletionProposal {
  ...
  public static final int ALIAS_REF =
      5; // ref to an alias name, e.g. "bar" in "from Bar as bar where b|"
  ...
  /**
   * A short entity name. e.g. the imported name. e.g. "Product" instead of
   * "org.hibernate.model.Product" (note: a imported name can also be the long version)
   */
