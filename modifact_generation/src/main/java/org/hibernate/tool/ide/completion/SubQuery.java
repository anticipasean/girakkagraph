...
public class SubQuery implements Comparable<SubQuery> {
      ...
      if (!afterFrom
        ...
        switch (type) {
          ...
          case HqlSqlTokenTypes.COMMA:
            joins.append(
                ","); // TODO: we should detect this and create the list directly instead of relying
            // on the tokenizer
            break;
  ...
  private void addEntityReferences(
      final List<EntityNameReference> tables, final StringBuffer tableNames) {
