...
/**
 * Oracle Specialised MetaData dialect that uses standard JDBC and querys on the Data Dictionary for
 * reading metadata.
 *
...
public class OracleMetaDataDialect extends AbstractMetaDataDialect {
  ...
  private static final String SQL_TABLE_SCHEMA =
      SQL_TABLE_BASE + "where a.owner like ? " + SQL_TABLE_VIEW + " where owner like ?";
  private static final String SQL_TABLE_TABLE =
      SQL_TABLE_BASE + "where a.table_name like ?" + SQL_TABLE_VIEW + "where view_name like ?";
  ...
  private static final String SQL_INDEX_SCHEMA =
      SQL_INDEX_BASE + "and a.table_owner like ? " + SQL_INDEX_ORDER;
  private static final String SQL_INDEX_TABLE =
      SQL_INDEX_BASE + "and a.table_name like ? " + SQL_INDEX_ORDER;
  private static final String SQL_INDEX_SCHEMA_AND_TABLE =
      SQL_INDEX_BASE + "and a.table_owner like ? and a.table_name like ? " + SQL_INDEX_ORDER;
  /* ****** COLUMN QUERIES ******* */
  ...
  private static final String SQL_COLUMN_SCHEMA =
      SQL_COLUMN_BASE + "where a.owner like ? " + SQL_COLUMN_ORDER;
  private static final String SQL_COLUMN_TABLE =
      SQL_COLUMN_BASE + "where a.table_name like ? " + SQL_COLUMN_ORDER;
  private static final String SQL_COLUMN_COLUMN =
      SQL_COLUMN_BASE + "where a.column_name like ? " + SQL_COLUMN_ORDER;
  private static final String SQL_COLUMN_SCHEMA_AND_TABLE =
      SQL_COLUMN_BASE + "where a.owner like ? and a.table_name like ? " + SQL_COLUMN_ORDER;
  private static final String SQL_COLUMN_SCHEMA_AND_COLUMN =
      SQL_COLUMN_BASE + "where a.owner like ? and a.column_name like ? " + SQL_COLUMN_ORDER;
  private static final String SQL_COLUMN_TABLE_AND_COLUMN =
      SQL_COLUMN_BASE + "where a.table_name like ? and a.column_name like ? " + SQL_COLUMN_ORDER;
  ...
  private static final String SQL_PK_ORDER =
      " order by c.table_name, c.constraint_name, c.position desc ";
  private static final String SQL_PK_NONE = SQL_PK_BASE + SQL_PK_ORDER;
  private static final String SQL_PK_SCHEMA =
      SQL_PK_BASE + " and c.owner like ? escape '\\' " + SQL_PK_ORDER;
  private static final String SQL_PK_TABLE =
      SQL_PK_BASE + " and c.table_name like ? escape '\\' " + SQL_PK_ORDER;
  private static final String SQL_PK_SCHEMA_AND_TABLE =
      SQL_PK_BASE
          + " and c.owner like ? escape '\\' and c.table_name like ? escape '\\' "
          + SQL_PK_ORDER;
  /* ***************************** */
  /* ******** FK QUERIES ********* */
  /* ***************************** */
  ...
  private static final String SQL_FK_SCHEMA = SQL_FK_BASE + " and p.owner like ? " + SQL_FK_ORDER;
  private static final String SQL_FK_TABLE =
      SQL_FK_BASE + " and p.table_name like ? " + SQL_FK_ORDER;
  private static final String SQL_FK_SCHEMA_AND_TABLE =
      SQL_FK_BASE + " and p.owner like ? and p.table_name like ? " + SQL_FK_ORDER;
  ...
  public Iterator<Map<String, Object>> getTables(
      final String catalog, final String schema, String table) {
    try {
  ...
  public Iterator<Map<String, Object>> getColumns(
      final String catalog, final String schema, final String table, String column) {
  ...
  private ResultSet getPrimaryKeysResultSet(final String schem, final String tab)
      throws SQLException {
  ...
  private ResultSet getIndexInfoResultSet(final String schema, final String table)
      throws SQLException {
  ...
  private ResultSet getColumnsResultSet(final String schema, final String table, String column)
      throws SQLException {
