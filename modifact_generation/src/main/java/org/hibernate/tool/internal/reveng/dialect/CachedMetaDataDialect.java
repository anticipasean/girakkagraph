...
public class CachedMetaDataDialect implements RevengDialect {
  ...
  private final Map<StringKey, List<Map<String, Object>>> cachedTables =
      new HashMap<StringKey, List<Map<String, Object>>>();
  private final Map<StringKey, List<Map<String, Object>>> cachedColumns =
      new HashMap<StringKey, List<Map<String, Object>>>();
  private final Map<StringKey, List<Map<String, Object>>> cachedExportedKeys =
      new HashMap<StringKey, List<Map<String, Object>>>();
  private final Map<StringKey, List<Map<String, Object>>> cachedPrimaryKeys =
      new HashMap<StringKey, List<Map<String, Object>>>();
  private final Map<StringKey, List<Map<String, Object>>> cachedIndexInfo =
      new HashMap<StringKey, List<Map<String, Object>>>();
  private final Map<StringKey, List<Map<String, Object>>> cachedPrimaryKeyStrategyName =
      new HashMap<StringKey, List<Map<String, Object>>>();
  ...
  public Iterator<Map<String, Object>> getColumns(
    ...
    if (cached == null) {
      ...
      return new CachedIterator(
          this, cachedColumns, sk, cached, delegate.getColumns(catalog, schema, table, column));
    } else {
  ...
  public Iterator<Map<String, Object>> getExportedKeys(
    ...
    if (cached == null) {
      cached = new ArrayList<Map<String, Object>>();
      return new CachedIterator(
          this, cachedExportedKeys, sk, cached, delegate.getExportedKeys(catalog, schema, table));
    } else {
      return cached.iterator();
    }
  }
  ...
  public Iterator<Map<String, Object>> getIndexInfo(String catalog, String schema, String table) {
    ...
    if (cached == null) {
      cached = new ArrayList<Map<String, Object>>();
      return new CachedIterator(
          this, cachedIndexInfo, sk, cached, delegate.getIndexInfo(catalog, schema, table));
    } else {
      return cached.iterator();
    }
  }
  ...
  public Iterator<Map<String, Object>> getPrimaryKeys(String catalog, String schema, String name) {
    ...
    if (cached == null) {
      cached = new ArrayList<Map<String, Object>>();
      return new CachedIterator(
          this, cachedPrimaryKeys, sk, cached, delegate.getPrimaryKeys(catalog, schema, name));
    } else {
      return cached.iterator();
    }
  }
  ...
  public Iterator<Map<String, Object>> getTables(String catalog, String schema, String table) {
    ...
    if (cached == null) {
      cached = new ArrayList<Map<String, Object>>();
      return new CachedIterator(
          this, cachedTables, sk, cached, delegate.getTables(catalog, schema, table));
    } else {
      return cached.iterator();
    }
  }
  ...
  private static class CachedIterator implements Iterator<Map<String, Object>> {
    ...
    public CachedIterator(
        CachedMetaDataDialect owner,
        Map<StringKey, List<Map<String, Object>>> destination,
        StringKey sk,
        List<Map<String, Object>> cache,
        Iterator<Map<String, Object>> realIterator) {
      this.owner = owner;
    ...
    public Map<String, Object> next() {
      ...
      cache.add(
          new HashMap<String, Object>(map)); // need to copy since MetaDataDialect might reuse it.
      return map;
    }
