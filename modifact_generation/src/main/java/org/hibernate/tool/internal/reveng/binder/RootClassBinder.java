...
public class RootClassBinder extends AbstractBinder {
  ...
  private void bindIncomingForeignKeys(
      PersistentClass rc, Set<Column> processed, RevengMetadataCollector revengMetadataCollector) {
    List<ForeignKey> foreignKeys =
        revengMetadataCollector.getOneToManyCandidates().get(rc.getEntityName());
    if (foreignKeys != null) {
