...
public interface POJOClass extends ImportContext {
  ...
  /**
   * Returns "package packagename;" where packagename is either the declared packagename, or the one
   * provide via meta attribute "generated-class".
   *
   * <p>Returns "// default package" if no package declarition available.
   */
