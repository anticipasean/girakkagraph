...
public final class XMLPrettyPrinterStrategyFactory {
  public static final String PROPERTY_STRATEGY_IMPL =
      "org.hibernate.tool.hbm2x.xml.XMLPrettyPrinterStrategy";
  ...
  private static XMLPrettyPrinterStrategy loadFromSystemProperty() {
    ...
    if (strategyClass != null) {
      try {
        Class<XMLPrettyPrinterStrategy> clazz =
            (Class<XMLPrettyPrinterStrategy>) Class.forName(strategyClass);
