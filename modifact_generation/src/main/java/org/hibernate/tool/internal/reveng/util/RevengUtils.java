...
public class RevengUtils {
  ...
  public static List<String> getPrimaryKeyInfoInRevengStrategy(
      RevengStrategy revengStrat, Table table, String defaultCatalog, String defaultSchema) {
  ...
  public static TableIdentifier createTableIdentifier(
      Table table, String defaultCatalog, String defaultSchema) {
  ...
  public static AssociationInfo createAssociationInfo(
      String cascade, String fetch, Boolean insert, Boolean update) {
