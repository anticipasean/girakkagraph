...
public class MetaAttributeHelper {
  ...
  public static MultiValuedMap<String, SimpleMetaAttribute> loadAndMergeMetaMap(
      Element classElement, MultiValuedMap<String, SimpleMetaAttribute> inheritedMeta) {
  ...
  /**
   * Merges a Multimap with inherited maps. Values specified always overrules/replaces the inherited
   * values.
   *
   * @param specific
   * @param general
   * @return a MultiMap with all values from local and extra values from inherited
   */
