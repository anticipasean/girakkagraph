...
public class CollectionSecondPass extends org.hibernate.cfg.CollectionSecondPass {
  ...
  public void doSecondPass(Map persistentClasses) throws MappingException {
    ...
    if (element instanceof DependantValue) {
      ...
      elementDependantValue.setForeignKeyName(
          "none"); // Workaround to avoid DependantValue to create foreignkey just because reference
      // columns are not the same + no need to create keys already in the db!
    }
