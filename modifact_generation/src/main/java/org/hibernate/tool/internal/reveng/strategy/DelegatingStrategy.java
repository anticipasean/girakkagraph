...
public class DelegatingStrategy implements RevengStrategy {
  ...
  public boolean excludeTable(TableIdentifier ti) {
    return delegate != null && delegate.excludeTable(ti);
  }

  public boolean excludeColumn(TableIdentifier identifier, String columnName) {
    return delegate != null && delegate.excludeColumn(identifier, columnName);
  }
  ...
  public String foreignKeyToCollectionName(
    ...
    return delegate == null
        ? null
        : delegate.foreignKeyToCollectionName(
  ...
  public String foreignKeyToEntityName(
    ...
    return delegate == null
        ? null
        : delegate.foreignKeyToEntityName(
            keyname,
            fromTable,
            fromColumnNames,
            referencedTable,
  ...
  public String columnToHibernateTypeName(
    ...
    return delegate == null
        ? null
        : delegate.columnToHibernateTypeName(
  ...
  public boolean useColumnForOptimisticLock(TableIdentifier identifier, String column) {
    return delegate != null && delegate.useColumnForOptimisticLock(identifier, column);
  }
  ...
  public boolean excludeForeignKeyAsCollection(
      ...
      List<?> referencedColumns) {
    return delegate != null
        && delegate.excludeForeignKeyAsCollection(
  ...
  public boolean excludeForeignKeyAsManytoOne(
      ...
      List<?> referencedColumns) {
    return delegate != null
        && delegate.excludeForeignKeyAsManytoOne(
            keyname, fromTable, fromColumns, referencedTable, referencedColumns);
  }
  ...
  public boolean isForeignKeyCollectionInverse(
      ...
      List<?> columns,
      Table foreignKeyReferencedTable,
      List<?> referencedColumns) {
    return delegate == null
        || delegate.isForeignKeyCollectionInverse(
            name, foreignKeyTable, columns, foreignKeyReferencedTable, referencedColumns);
  }
  ...
  public boolean isForeignKeyCollectionLazy(
      ...
      List<?> referencedColumns) {
    return delegate == null
        || delegate.isForeignKeyCollectionLazy(
            name, foreignKeyTable, columns, foreignKeyReferencedTable, referencedColumns);
  }
   ...
   *
   * <p>If subclasses need to use the Settings then it should keep its own reference, but still
   * remember to initialize the delegates settings by calling super.setSettings(settings).
   *
  ...
  public boolean isManyToManyTable(Table table) {
    return delegate == null || delegate.isManyToManyTable(table);
  }

  public boolean isOneToOne(ForeignKey foreignKey) {
    return delegate == null || delegate.isOneToOne(foreignKey);
  }
  ...
  public String foreignKeyToManyToManyName(
    ...
    return delegate == null
        ? null
        : delegate.foreignKeyToManyToManyName(fromKey, middleTable, toKey, uniqueReference);
  }
  ...
  public String foreignKeyToInverseEntityName(
    ...
    return delegate == null
        ? null
        : delegate.foreignKeyToInverseEntityName(
            keyname,
            fromTable,
            fromColumnNames,
            referencedTable,
