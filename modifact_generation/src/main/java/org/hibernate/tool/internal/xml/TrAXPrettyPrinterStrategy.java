...
public class TrAXPrettyPrinterStrategy extends AbstractXMLPrettyPrinterStrategy {
  ...
  protected Transformer newTransformer(final Document document)
    ...
    transformer.setOutputProperty(
        OutputKeys.OMIT_XML_DECLARATION, isOmitXmlDeclaration() ? "yes" : "no");
    try {
      transformer.setOutputProperty(
          "{http://xml.apache.org/xslt}indent-amount", String.valueOf(getIndent()));
