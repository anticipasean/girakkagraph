...
public class TestCase {
  ...
  public void setUp() {
    ...
    metadata =
        MetadataDescriptorFactory.createReverseEngineeringDescriptor(c, null).createMetadata();
  }
  ...
  public void testBinding() throws HibernateException, SQLException {
    ...
    String schemaToUse = Environment.getProperties().getProperty(AvailableSettings.DEFAULT_SCHEMA);
    PersistentClass orders = metadata.getEntityBinding(PACKAGE_NAME + ".Orders");
